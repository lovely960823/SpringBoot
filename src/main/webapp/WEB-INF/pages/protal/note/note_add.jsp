...
<br>
		<form class="form-horizontal" role="form" autocomplete="off" id="form1">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="hello" name="createTime" class="laydate-icon form-control layer-date" placeholder="请选择时间">
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-9" align="center">
					...
					<input type="button" class="btn btn-primary" value="发布" onclick="ensuresubmit()" >
				</div>
			</div>
		</form>
...
<script src="${pageContext.request.contextPath }/static/js/plugins/layer/laydate/laydate.js"></script>
   ...
   function ensuresubmit(){
	   ...
	   $.ajax({
       	url:"${pageContext.request.contextPath }/protal/note/doNotePub",
